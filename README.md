...
- **丰富但不抢戏**：257 个表情与姿态，包含 24 个情绪家族的 96 套基础表达与 12 套复合小心思；另有 255 套活动（含 32 套约 15 秒连续动作和 34 套独立任务表演）、15 套眼部方案、18 种形状、45 件道具、24 种整脸面具。
...
32 套连续小剧场，配合专注思考、好奇张望、犹豫检查、疲惫伸展，随着任务和你的操作切换神态。
...
| 活动编排 | 255 套 | 做笔记、转笔、理线、试拼、风车、悠悠球 |
| 独立任务表演 | 上述活动中的 34 套 | 开始 7 套、进行中 9 套、完成 11 套、异常与待处理 7 套 |
| 眼部方案 | 15 套 | 8 套常驻眼型、7 套情境眼神；统一眨眼、视线与眼皮裁切 |
| 连续小剧场 | 上述活动中的 32 套 | 每套约 15 秒，带准备、表演和收尾，配有细微演出变化 |
