...
- **丰富但不抢戏**：149 个表情与姿态、202 套活动（含 20 套约 15 秒连续动作和 23 套独立任务表演）、9 种眼睛风格、18 种形状、24 件道具、24 种整脸面具。
...
| 活动编排 | 202 套 | 做笔记、转笔、画画、折纸飞机、魔术、伸展 |
| 独立任务表演 | 上述活动中的 23 套 | 开始 5 套、进行中 6 套、完成 7 套、异常与待处理 5 套 |
| 眼睛风格 | 9 种 | 经典、动漫、漫画、极简、像素、霓虹、墨线、慵懒、不对称 |
