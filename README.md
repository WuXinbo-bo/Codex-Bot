...
- **丰富但不抢戏**：257 个表情与姿态，包含 24 个情绪家族的 96 套基础表达与 12 套复合小心思；另有 211 套活动（含 20 套约 15 秒连续动作和 23 套独立任务表演）、15 套眼部方案、18 种形状、24 件道具、24 种整脸面具。
- **日常小心思**：基础神态保持约 6–12 秒，眼神、轻点头和手部动作自然错开；18 种无嘴巴情绪装饰按情境出现，同一种情绪轮换不同表达。
- **有记忆的小故事**：5 条故事线、9 段新编动作，排练后递交、藏起再拿出道具、完成后等待回应。
- **自动外观**：5 种整体画风、眼睛和情绪形态自然轮换，也可以单独固定；18 种基础身体轮廓统一圆润处理，像素画风仍保留方格与阶梯边缘。
