...
if (tauri) {
  ...
  window.metaBot = {
    ...
    recordPerformance: value=>request('performance-record',[value]),
    getPerformanceLibrary: ()=>request('performance-library'),
    setPerformancePreference: (name,value)=>request('performance-preference',[name,value]),
    replayPerformance: name=>request('performance-replay',[name]),
    onPerformanceLibrary: fn=>subscribe('performance:library',fn),
