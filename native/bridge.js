...
if (tauri) {
  ...
  window.metaBot = {
    ...
    onTaskBoard: fn => subscribe('board:update', fn),
    onBoardSettingsClose: fn => subscribe('board:settings-close', fn),
    boardPresentation: value => request('board-presentation', [value]),
    boardTaskAction: value => request('board-task', [value]),
