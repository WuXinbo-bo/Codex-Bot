(function (root, factory) {
  ...
  const SPECIAL = {
    ...
    unravel: ['有点晕乎','soft_square',{eyes:both({symbols:{spiral:1}}),body:{rx:56,ry:48,rotate:8},arms:{left:ARMS.down,right:ARMS.down},accents:{stress:.7}}],
    composed: ['强装镇定','focus',{eyes:both({upper:.36}),gaze:{x:.6,y:.25},accents:{sweat:1},arms:{left:ARMS.grip,right:ARMS.grip},breathe:.006}],
    smug: ['得意邀功','classic',{eyes:{left:{upper:.5},right:{lower:.3}},gaze:{x:0,y:-.3},body:{rotate:-8,cy:61},accents:{blush:.55},arms:{right:ARMS.salute}}],
